...
class AdvanceFeeController extends Controller
{
    ...
    public function submit(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'role' => 'required|in:Wholesaler,Dispo Company,JV Partner,Other',

            // Deal Snapshot
            'propertyAddress' => 'required|string|max:500',
            'state' => 'required|alpha|size:2',
            'closingDate' => 'required|date|after_or_equal:today',
            'dealType' => 'required|in:Assignment,Double Close,Novation / Wholetail,Other',
            ...
            'fundingWhen' => 'required|in:Same day,Within 24 hours,Within 48 hours,This week',
            ...
            'useOfFunds' => 'nullable|in:Marketing / Ads,Earnest Money for another deal,Paying Dispo / JV,Business operations,Personal / Emergency,Other',
            ...
            'buyerType' => 'nullable|in:Cash,Hard Money,Conventional Financing,Other',

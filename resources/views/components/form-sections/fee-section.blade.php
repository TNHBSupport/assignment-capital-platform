<div class="mb-4">
    ...
    <div class="row g-3">
        ...
        <div class="col-md-6">
            ...
            <input name="advanceRequestedMin" id="advanceRequestedMin" class="form-control" type="number" min="0" step="1" required />
        ...
        <div class="col-md-6">
            ...
            <input name="advanceRequestedMax" id="advanceRequestedMax" class="form-control" type="number" min="0" step="1" required />
